...
for count,each in enumerate(contents):
    ...
    for window, transform in get_tiles(img):
        ...
        if window.height == 256 and window.width == 256:
            ...
            B_bands = B_bands[B_bands['65'] == 1]
            B_bands_original = B_bands_original[B_bands_original['65'] == 1]
    ...
    if all_bands.shape[0] == 0:
        ...
        filename = 'E:/SCC/SCC3/TYP/ml4floods/codes/models/'+str(each)+'_'+str(count)+'_land_model.sav'
